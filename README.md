...
The platform includes features such as user authentication, lab management, progress tracking, networking simulations, and a RESTful API. A live demo is available [here](https://aist-alisagafarovas-projects.vercel.app/).
